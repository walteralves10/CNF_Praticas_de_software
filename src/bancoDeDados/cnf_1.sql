...
--
-- Host: localhost
-- Generation Time: 10-Dez-2019 às 12:19
...
INSERT INTO `aluno` (`codigo_aluno`, `nome_aluno`, `cpf_aluno`, `status_aluno`) VALUES
(1, 'jefferson guedes nao quero', '052.232.841-51', 0),
(2, 'gtx viadinho', '029.352.461-01', 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `auxturmaaluno`
--

CREATE TABLE `auxturmaaluno` (
  `fk_codigo_aluno` int(11) NOT NULL,
  `fk_codigo_turma` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `turma` (
  ...
  `fk_codigo_professor` int(11) NOT NULL,
  `semestre_turma` int(11) NOT NULL,
  `ano_turma` int(11) NOT NULL,
  `status_turma` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `aluno`
  MODIFY `codigo_aluno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
