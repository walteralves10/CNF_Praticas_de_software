...
public class Aluno extends javax.swing.JFrame {
   ...
   Controle controle = new Controle();
    ...
    private void pesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisaActionPerformed
        ...
        aluno.setNome_aluno(nome.getText());
        aluno.setStatus_aluno(status.getSelectedIndex());
        //System.out.println(cpf.getText());
        if(cpf.getText().equals("   .   .   -  ")){
            aluno.setCpf_aluno("");
        } else {
            aluno.setCpf_aluno(cpf.getText());
        }

        ArrayList<AlunoBEAN> listAluno = controle.listaAlunoPorNome(aluno);

        if (listAluno.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Aluno não encontrada!");
        } else {
            preencher_tabela(listAluno);
        }
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        AlunoBEAN listaAlunos
        = controle.listaStatusAluno(Integer.parseInt(tabela.getValueAt(linhaEditora, 0).toString()));
        if (listaAlunos.getStatus_aluno()== 0) {
...
public void preencher_tabela(List<AlunoBEAN> listAlunos) {
        ...
        modelo.setNumRows(0);
        try {
            for (AlunoBEAN aluno : listAlunos) {
                modelo.addRow(new Object[]{aluno.getCodigo_aluno(), 
                    aluno.getNome_aluno(), aluno.getCpf_aluno()});
            }
